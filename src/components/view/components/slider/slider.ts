import { SliderAssemblerSettings } from "./interfaces/sliderInterfaces";
...
export class Slider {
  ...
  private isNeedToMakeHorizontally(isVertical: boolean): boolean {
    return this.slider.classList.contains("cs-slider_vertical") == true && isVertical == false;
  };

  private isNeedToMakeVertical(isVertical: boolean): boolean {
    return this.slider.classList.contains("cs-slider_vertical") == false && isVertical == true;
  };
