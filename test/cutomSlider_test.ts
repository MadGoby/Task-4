...
describe('Facade', function() {
  ...
  it(' startHandelsPosition() returns an object transmitted by getCurrentData() ', function() {
    expect(facade.getStartHandelsPosition()).toEqual(model.getCurrentData());
  });
